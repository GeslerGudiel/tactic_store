...
try {
    ...
    $query = "UPDATE producto SET estado = 'disponible' WHERE id_producto = :id_producto";
    ...
    if ($stmt->execute()) {
        $_SESSION['message'] = [
            'type' => 'success',
            'text' => 'El producto ha sido aprobado y está disponible.'
        ];
    } else {
        $_SESSION['message'] = [
            'type' => 'error',
            'text' => 'Hubo un error al aprobar el producto.'
        ];
    }
