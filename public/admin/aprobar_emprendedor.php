...
// Actualizar el estado del emprendedor a "Activado" (id_estado_usuario = 2)
$query = "UPDATE emprendedor SET id_estado_usuario = 2 WHERE id_emprendedor = :id_emprendedor";
$stmt = $db->prepare($query);
$stmt->bindParam(':id_emprendedor', $id_emprendedor);

if ($stmt->execute()) {
    $_SESSION['message'] = "El emprendedor ha sido aprobado exitosamente.";
} else {
    $_SESSION['message'] = "Error al aprobar al emprendedor.";
}
