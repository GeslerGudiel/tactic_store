<?php
session_start();  // Inicie de sesión antes de cualquier salida HTML.
...
<body>
    <div class="container mt-5">
        ...
        <form action="forgot_password_process.php" method="POST" class="mx-auto" style="max-width: 400px;">
            ...
            <button type="submit" class="btn btn-primary w-100"><i class="fas fa-paper-plane"></i> Enviar Enlace de Recuperación</button>
        </form>
    </div>
