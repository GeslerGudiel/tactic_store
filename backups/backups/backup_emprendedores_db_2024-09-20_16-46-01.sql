...
INSERT INTO `categoria` VALUES (1,'Computación','Todo en la computación.'),(2,'Cuidado Personal',''),(3,'Útiles Escolares','Todo tipo de materiales para el estudiante.'),(5,'Mascotas','Todo lo relacionado a mascotas.'),(6,'Ropa',''),(7,'Jardinería',''),(9,'Hogar',''),(13,'Deportes','Todo tipo de deportes.'),(14,'Salud',''),(21,'Floristería',''),(22,'Electrónicos y Más','');
...
INSERT INTO `cliente` VALUES (1,'456','Gudiel','Gesler','','Mó','Quej','geslermo@vida.edu.gt','$2y$10$QLm/uGTqPepBB8ebwnomcOUz0/lAgAirnggXxDacMPd3RXVBDPrle','123','123',3,4,'5b4614878918b89866d73a27622eb235f0ba84f0b74da2b667793878cf237b57b47a86c608925d4f7de3c48a7e40050b7b44',NULL,'2024-08-29 04:45:43');
...
INSERT INTO `subcategoria` VALUES (1,1,'Computadoras de escritorio',''),(2,1,'Computadoras portátiles',''),(5,6,'Ropa para niños',''),(6,7,'Macetas',''),(7,5,'Ropa para mascotas',''),(8,6,'Ropa para damas','');
...
-- Dump completed on 2024-09-20 16:46:02
